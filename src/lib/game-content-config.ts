...
export const defaultGameContentConfigs: EditableGameContent[] = [
  ...
  },
  {
    ...
    itemLines: ["小手扶好碗｜碗不乱跑。", "小脚放稳｜身体坐舒服。", "嘴巴轻轻嚼｜细嚼慢咽。", "按需取餐｜吃多少取多少。", "餐后会整理｜碗筷桌面归位。"],
    updatedAt: nowLabel,
  },
  {
    ...
    reminderText: "好习惯红绿牌完成啦：能判断饭前洗手、细嚼慢咽、按需取餐和餐后整理。",
    teacherNote: "用于观察幼儿能否用红绿牌判断进餐和生活习惯，并说出替代做法。",
    itemLines: ["饭前洗手｜绿牌。", "边吃边玩｜红牌。", "细嚼慢咽｜绿牌。", "撒饭不收拾｜红牌。", "按需取餐｜绿牌。"],
    updatedAt: nowLabel,
  },
];
