...
export const defaultGameContentConfigs: EditableGameContent[] = [
  ...
  },
  {
    ...
    themeId: "habit",
    title: "习惯故事小剧场",
    childGoal: "找一本小故事，听一听绘本，翻到最后一页，再点亮阅读小贴纸。",
    reminderText: "习惯故事小剧场完成啦：你认真听完一本小故事，阅读小贴纸来啦。",
    teacherNote: "用于观察幼儿是否愿意听绘本、翻页、表达喜欢的故事，并养成阅读打卡习惯。",
    itemLines: ["📚 找小故事｜我想听什么。", "🔊 听绘本｜一页一页慢慢听。", "🌟 今天读完啦｜点亮阅读贴纸。"],
    updatedAt: nowLabel,
  },
  {
    gameKey: "foodObserve",
    ...
    itemLines: ["🦪 海边鲜味摊｜海蛎煎、土笋冻、崇武鱼卷。", "🥣 古城小吃摊｜面线糊、牛肉羹、咸饭。", "🍧 甜甜清凉摊｜石花膏、四果汤、芋头饼。", "🍙 家常饭菜摊｜姜母鸭、烧肉粽、炸醋肉、洪濑鸡爪。"],
    updatedAt: nowLabel,
  },
  {
    gameKey: "foodTrain",
  ...
  },
  {
    ...
    reminderText: "美食观察与靠近一点点完成啦：你愿意先看一看、听一听，已经靠近一小步。",
    teacherNote: "用于观察幼儿对陌生泉州美食的接受情况，后续给老师生成温和食育策略。",
    itemLines: ["食物选择｜海蛎煎、面线糊、土笋冻、姜母鸭、烧肉粽、芋头饼、牛肉羹、四果汤等。", "原因选择｜味道、颜色、口感、没见过。", "幼儿端反馈｜食物角色介绍食材，不贴负面标签。"],
    updatedAt: nowLabel,
  },
  {
  ...
  },
  {
    ...
    themeId: "food",
    title: "泉州小厨房",
    childGoal: "选择一道泉州美食，看菜品图，按顺序点步骤卡，完成一道小小泉州菜。",
    reminderText: "泉州小厨房完成啦：小厨师按步骤做完一道菜，成品图也亮出来啦。",
    teacherNote: "用于生活区、语言区和表演区活动，观察幼儿是否能理解步骤顺序、参与制作小步并表达发现。",
    itemLines: ["选择美食｜姜母鸭、烧肉粽、土笋冻、海蛎煎等。", "步骤图卡｜看一看、洗一洗、拌一拌、盛一盛。", "小厨师完成｜说一句我做了哪一步。", "安全提醒｜和老师或家长一起做。"],
    updatedAt: nowLabel,
  },
  {
    ...
    itemLines: ["海蛎煎｜找金黄边。", "土笋冻｜看透明样子。", "姜母鸭｜找姜片。", "芋头饼｜看圆圆小饼。"],
    updatedAt: nowLabel,
  },
  {
    gameKey: "mealTray",
    ...
    itemLines: ["海蛎煎｜认识蛋白质和海味。", "面线糊｜认识主食能量。", "姜母鸭｜认识鸭肉和老姜。", "烧肉粽｜认识糯米和粽叶。", "崇武鱼卷｜认识鱼肉蛋白。", "四果汤｜认识清凉甜品。"],
    updatedAt: nowLabel,
  },
  {
    gameKey: "mealManners",
