...
export const defaultGameContentConfigs: EditableGameContent[] = [
  ...
  },
  {
    ...
    themeId: "food",
    title: "泉州小厨房",
    childGoal: "选一道泉州美食，按顺序点制作动作卡，听小厨师口令，完成区域游戏打卡。",
    reminderText: "泉州小厨房完成啦：能按步骤参与制作角色扮演，也懂得帮忙和整理。",
    teacherNote: "用于语言区、生活区和表演区活动，观察幼儿是否能按步骤操作和表达。",
    itemLines: ["海蛎煎｜洗一洗、拌一拌、煎一煎、摆一摆。", "面线糊｜看一看、搅一搅、盛一盛、说一说。", "润饼菜｜铺一铺、放一放、卷一卷、介绍一下。", "石花膏｜舀一舀、加一加、拌一拌、分享一下。"],
    updatedAt: nowLabel,
  },
  {
    ...
    reminderText: "历史同伴鼓励记录已保留，可在老师端继续查看。",
  ...
  },
  {
    ...
    reminderText: "历史午餐小餐盘记录已保留，可在老师端继续查看。",
